...
| [secrets-inventory](secrets-inventory.md) | infra (GCP Secret Manager, Grafana, Cloudflare, GitHub) | Ledger of every external-service token: canonical name, scopes, source of truth, usage sites, rotation owner. |
